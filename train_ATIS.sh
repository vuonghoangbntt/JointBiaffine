#!/bin/bash
export TRAIN_PATH="data/atis/train.json"
export DEV_PATH="data/atis/dev.json"
export TEST_PATH="data/atis/test.json"
export CHAR_VOCAB_PATH="data/atis/char_index.json"
export INTENT_LABEL_PATH="data/atis/intent_label.txt"
export SLOT_LABEL_PATH="data/atis/slot_label.txt"
...
export SAVE_FOLDER="results/atis"
